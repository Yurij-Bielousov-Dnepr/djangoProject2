...
urlpatterns = [
    ...
    path( 'offer/helpers/<int:pk>/update/', views.HelperUpdateView.as_view(), name='update_helper_info' ),
    path( 'offer/helpers/<int:pk>/delete/', views.HelperDeleteView.as_view(), name='delete_helper' ),
