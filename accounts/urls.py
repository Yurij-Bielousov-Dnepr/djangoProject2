...
urlpatterns = [
    ...
    path( 'accounts/password_reset_from_key/', views.password_reset_from_key, name='password_reset_from_key' ),
    path( 'accounts/password_reset_from_key_done/', views.password_reset_from_key_done,
