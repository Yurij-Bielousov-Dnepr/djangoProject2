...
class Tag_help(models.Model):
    ...
    name = models.CharField(max_length=255, choices=name_choices, verbose_name=_('Name'))
...
class HelpRequest(models.Model):
    ...
    problem_description = models.TextField(max_length=255,  blank=False, null=False, default='-= =-' )
    ...
    contacts = models.CharField( max_length=255, blank=False, null=False, default='12345' )
    def __str__(self):
